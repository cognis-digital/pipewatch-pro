"""Native cognis-connect emit for pipewatch-pro — forward findings to any platform.

Maps pipewatch-pro's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    pipewatch-pro ... --format json | pipewatch-pro-emit --to stix
    pipewatch-pro-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
