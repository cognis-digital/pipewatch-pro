#!/usr/bin/env sh
# Universal installer for pipewatch-pro. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/pipewatch-pro.git"
echo "Installing pipewatch-pro ..."
...
echo "Done. Run: pipewatch-pro --help"
